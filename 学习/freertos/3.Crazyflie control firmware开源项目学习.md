...
1. 声明任务内存 `STATIC_MEM_TASK_ALLOC(systemTask, SYSTEM_TASK_STACKSIZE)`
2. 创建任务 `STATIC_MEM_TASK_CREATE(systemTask, systemTask, SYSTEM_TASK_NAME, NULL, SYSTEM_TASK_PRI)`
# 三、附属小知识
### C 预处理器 ## 符号说明
