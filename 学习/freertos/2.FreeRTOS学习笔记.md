...
![](assets/2.FreeRTOS学习笔记/file-20260721164234669.png)
2. 配置freertos相关设置。
![](assets/2.FreeRTOS学习笔记/file-20260721164321153.png)
![](assets/2.FreeRTOS学习笔记/file-20260721164340893.png)
![](assets/2.FreeRTOS学习笔记/file-20260721164510684.png)
# 二、任务系统的创建与调度
项目目标：能够使用freertos创建任务。
1. 在freertos.c中创建一个初始化函数，默认创建了一个任务：defaultTaskHandle。
![](assets/2.FreeRTOS学习笔记/file-20260721171444987.png)
2. 谈CMSIS。
...
![](assets/2.FreeRTOS学习笔记/file-20260723160951848.png)
2. 关键函数
```c
//任务的挂起与恢复
